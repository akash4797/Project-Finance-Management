...
public class Home extends JFrame implements FocusListener , MouseListener {
    ...
    JTextField proName,branchName,proAdd,comBankName,projectSearch;
    JDateChooser date;
   ...
   //static String full,u,d,iema;
    ...
    Home(String fullname,String userName,String ideg,String iemail) throws ClassNotFoundException, SQLException{
   ...
   projectTable.getColumnModel().getColumn(0).setPreferredWidth(5);
   ...
   edit.addActionListener((ActionEvent ae) -> {
     ...
     createPro.addActionListener((ActionEvent ae) -> {
         ...
         DateFormat df = new SimpleDateFormat("dd-MM-yyyy");
                  ...
                  try {
                      myData r = new myData();
                      r.projectAdding(proName.getText(), branchName.getText(), proAdd.getText()
                              , comBankName.getText(),df.format(date.getDate()));
    ...
    public void picLoad() throws ClassNotFoundException, SQLException   {
    ...
    public void homePageLoader() throws ClassNotFoundException, SQLException{
    
     double[] originArray = new double[3];
        
    myData c = new myData();
    originArray = c.homePageLoader();
    ...
    public void mouseEntered(MouseEvent me) {
        ...
        if(me.getSource()==searchpnl || me.getSource()==projectSearch
                || me.getSource()==sp || me.getSource()==projectTable){
    ...
    public void mouseExited(MouseEvent me) {
           ...
           if(me.getSource()==searchpnl){
             ...
             if(sp.getMousePosition()==null || projectTable.getMousePosition()==null){
    ...
    projectSearch.setBounds(-(projectSearch.getWidth()+4),projectSearch.getY(),projectSearch.getWidth(),projectSearch.getHeight());
    
        darkui2.setBounds(projectSearch.getX()+5,projectSearch.getY()+5,
            projectSearch.getWidth(),projectSearch.getHeight());
        
                   sp.setBounds(-(sp.getWidth()+10),darkui2.getY()+darkui2.getHeight()+30,
                           searchpnl.getWidth(),
