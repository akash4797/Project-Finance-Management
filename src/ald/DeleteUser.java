...
public class DeleteUser extends JDialog implements KeyListener {
    ...
    }catch(ClassNotFoundException | SQLException aa){
    ...
    setBounds((int) (screen.getWidth()/2)-250, 
       (int) (screen.getHeight()/2)-300,500,600);
    setResizable(false);
    ...
    detail.setFont(fd);
    detail.setBounds(src.getX(),sp.getY()+sp.getHeight()+10,150,50);
    this.add(detail);
